                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            ...
                                                            <div class="form-group mb-3 row">
                                                                ...
                                                                <input class="form-control col-xl-8 col-sm-7" type="text" name="nama_produk" value="<?= $data['name'] ?>" required="">
                                                            </div>
                                                            <div class="form-group mb-3 row">
                                                                <label class="col-xl-3 col-sm-4 mb-0">
                                                                    Harga
                                                                </label>
                                                                <input class="form-control col-xl-8 col-sm-7" name="harga_produk" type="text" id="rupiah" min="0" value="<?= $data['price'] ?>" required="">
                                                            </div>
                                                            <div class="form-group mb-3 row">
                                                                <label class="col-xl-3 col-sm-4 mb-0">
                                                                    Kode KBLI
                                                                </label>
                                                                <input class="form-control col-xl-8 col-sm-7" name="kbli_produk" type="text" value="<?= $data['kbli'] ?>" required="">
                                                            </div>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-xl-9 col-sm-8 pl-0 description-sm">
                                                                    <textarea id="editor1" class="col-xl-10 col-sm-8" name="deskripsi_produk" cols="12" rows="4">
                                                                        <?= $data['description'] ?>
                                                                    </textarea>
                                                                </div>
                                                            </div>
