...
<body class="bg-light">
    ...
    <!-- section start -->
    <section class="section-big-pt-space bg-light mb-3">
                    ...
                    <div class="col-lg-7 rtl-text">
                        <div class="product-right">
                            ...
                            <div class="product-buttons">
                                <a href="#" data-toggle="modal" data-target="#addtocart" class="btn btn-normal">Masukkan
                                    keranjang</a>
                                                            ...
                                                            <div class="single-product-tables">
                                                                <table>
                                                                    <tbody>
                                                                        ...
                                                                        <tr>
                                                                            <td>Deskripsi</td>
                                                                            <td>Deskripsi Produk di sini</td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td>Stok</td>
                                                                            <td>500</td>
