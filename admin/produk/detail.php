                        ...
                        <div class="row product-page-main card-body">
                            <div class="col-xl-4">
                                <div class="product-slider owl-carousel owl-theme" id="sync1">
                                    ...
                                    ?>
                                        <div class="item">
                                            <img src="../../supplier/assets/produk/<?= $row['image'] ?>" alt="" class="blur-up lazyloaded">
                                        </div>
                                    <?php } ?>
                                </div>
                                <div class="owl-carousel owl-theme" id="sync2">
                                    ...
                                    while ($row = $result->fetch(PDO::FETCH_ASSOC)) {
                                    ?>
                                        <div class="item"><img src="../../supplier/assets/produk/<?= $row['image'] ?>" alt="" class="blur-up lazyloaded"></div>
                                    <?php } ?>
                                </div>
                            </div>
                            <?php
