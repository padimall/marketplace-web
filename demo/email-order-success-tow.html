    ...
    <tr>
        <td>
            ...
            <table class="order-detail" border="0" cellpadding="0" cellspacing="0"  align="left" style="width: 100%;    margin-bottom: 50px;">
                ...
                <tr>
                    <td>
                        <img src="../assets/images/email-temp/pro-1.jpg" alt="" width="80">
                    </td>
                ...
                <tr>
                    <td>
                        <img src="../assets/images/email-temp/pro-2.jpg" alt="" width="80">
                    </td>
                    <td valign="top" style="padding-left: 15px;">
                        <h5 style="margin-top: 15px;">Three seater Wood Style sofa for Leavingroom </h5>
                    </td>
                ...
                <tr>
                    <td>
                        <img src="../assets/images/email-temp/pro-3.jpg" alt="" width="80">
                    </td>
                    <td valign="top" style="padding-left: 15px;">
                        <h5 style="margin-top: 15px;">Three seater Wood Style sofa for Leavingroom </h5>
                    </td>
